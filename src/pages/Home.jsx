        ...
        <div ref={pageRef}>
            ...
            >
                ...
                <div className="container" style={{ position: 'relative', zIndex: 1, color: 'var(--color-warm-white)' }}>
                    ...
                    <h1 className="reveal delay-100" style={{ fontSize: 'clamp(3rem, 6vw, 5.5rem)', maxWidth: '900px', marginBottom: '1.5rem', lineHeight: '1.1' }}>
                        Designing Timeless Spaces with a Kenyan Soul.
                    </h1>
                    <p className="reveal delay-200" style={{ fontSize: '1.2rem', marginBottom: '3rem', maxWidth: '600px', opacity: 0.9 }}>
                        Luxury Afro-Modern interiors that blend contemporary global design with authentic Kenyan heritage.
                    </p>
                ...
                <div className="container">
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
                        <div className="reveal">
                            <span className="subtitle" style={{ marginBottom: '1rem' }}>The Studio</span>
                            <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', marginBottom: '1.5rem' }}>Where Heritage Meets Modern Luxury.</h2>
                            <p style={{ fontSize: '1.1rem', marginBottom: '1.5rem', color: 'var(--text-secondary)' }}>
                                Bree Interiors specializes in high-end residential interiors, boutique hotels, and diaspora dream homes in Kenya. We believe that a space should tell a story—your story, rooted in culture but elevated for modern living.
                            </p>
                            <p style={{ fontSize: '1.1rem', marginBottom: '2rem', color: 'var(--text-secondary)' }}>
                                Our signature design approach brings together natural textures, artisan craftsmanship, and refined elegance.
                            </p>
            ...
            <section className="section">
                <div className="container text-center reveal">
                    <span className="subtitle mb-2">Signature Style</span>
                    <h2 className="heading-lg mb-4">Savannah Minimalism™</h2>
                    <p style={{ maxWidth: '700px', margin: '0 auto', fontSize: '1.2rem', color: 'var(--text-secondary)' }}>
                        Inspired by the vast serene landscapes of Kenya, this aesthetic balances the warmth of earthy terracotta and sand tones with the clean lines of modern minimalism.
                    </p>
                </div>
            </section>
            ...
            <section className="section bg-secondary">
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' }}>
                        <div className="reveal delay-100" style={{ cursor: 'pointer', group: 'true' }}>
                            <div style={{ aspectRatio: '4/3', backgroundColor: '#e0d8d0', overflow: 'hidden', marginBottom: '1.5rem' }}>
                                <img src="/diani_villa.png" alt="Diani Beach Villa" style={{ width: '100%', height: '100%', objectFit: 'cover', transition: 'transform 0.5s ease' }} />
                            </div>
                            <span style={{ fontSize: '0.85rem', color: 'var(--color-terracotta)', textTransform: 'uppercase', letterSpacing: '1px' }}>Boutique Hotel</span>
                            <h3 style={{ fontSize: '1.5rem', marginTop: '0.5rem' }}>Diani Coastal Villa</h3>
                        </div>

                        <div className="reveal delay-200" style={{ cursor: 'pointer', group: 'true' }}>
                            <div style={{ aspectRatio: '4/3', backgroundColor: '#e0d8d0', overflow: 'hidden', marginBottom: '1.5rem' }}>
                                <div style={{ width: '100%', height: '100%', backgroundColor: 'var(--color-charcoal)' }}></div>
                            </div>
                            <span style={{ fontSize: '0.85rem', color: 'var(--color-terracotta)', textTransform: 'uppercase', letterSpacing: '1px' }}>Residential</span>
                            <h3 style={{ fontSize: '1.5rem', marginTop: '0.5rem' }}>Nairobi Penthouse</h3>
                        </div>

                        <div className="reveal delay-300" style={{ cursor: 'pointer', group: 'true' }}>
                            <div style={{ aspectRatio: '4/3', backgroundColor: '#e0d8d0', overflow: 'hidden', marginBottom: '1.5rem' }}>
                                <div style={{ width: '100%', height: '100%', backgroundColor: 'var(--color-muted-olive)' }}></div>
                            </div>
                            <span style={{ fontSize: '0.85rem', color: 'var(--color-terracotta)', textTransform: 'uppercase', letterSpacing: '1px' }}>Airbnb Styling</span>
                            <h3 style={{ fontSize: '1.5rem', marginTop: '0.5rem' }}>Muthaiga Escape</h3>
                        </div>
                    </div>
                </div>
            </section>
