...
const About = () => {
    ...
    return (
        <PageTransition>
            <SEO
                title="Our Story | Bree Interiors"
                description="Discover the philosophy driving Bree Interiors: bridging contemporary global design trends and authentic Kenyan materiality."
            />
                    ...
                    <div className="container grid-2-col">
                        ...
                        <div className="reveal delay-200">
                            <div style={{ aspectRatio: '3/4', backgroundColor: 'var(--color-sand)', overflow: 'hidden' }}>
                                <ImageWithSkeleton src={content.about_image_url} alt="Bree Interiors Studio Workspace" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                            </div>
                        </div>
                    </div>
                </section>
