...
const Sustainability = () => {
    ...
    return (
        <PageTransition>
            <SEO
                title="Sustainability | Bree Interiors"
                description="Bree Interiors is committed to eco-conscious design that uplifts local communities and respects the environment."
            />
